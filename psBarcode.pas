...
uses
  WinProcs, WinTypes, VCL.Graphics, Messages, VCL.Controls, VCL.Printers, VCL.ClipBrd,
  VCL.Dialogs,  VCL.Forms, Classes, SysUtils, VCL.StdCtrls,
...
begin
      ...
      constAboutProduct       := 'Barcode Studio - PSOFT ?996-2010';
