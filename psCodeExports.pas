...
uses Classes, Types, Windows, SysUtils, VCL.Controls, VCL.Graphics, VCL.ClipBrd, VCL.Dialogs, VCL.Forms,
  {$IFDEF PSOFT_JPEG} VCL.Imaging.JPeg, {$ENDIF}
  {$ifdef PSOFT_GIF} VCL.Imaging.GifImg, VCL.Imaging.PNGImage, {$endif}
