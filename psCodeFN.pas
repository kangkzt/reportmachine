...
uses Types, Classes, Windows, SysUtils, VCL.Graphics, VCL.Forms, ShellAPI, VCL.Dialogs,
      VCL.Controls, VCL.ComCtrls, VCL.Printers, Math, VCL.StdCtrls, VCL.ExtCtrls, VCL.Buttons,
      Variants, VCL.CheckLst, RichEdit,
