...
uses Classes, Messages, Types, VCL.Graphics, SysUtils, Math, Windows;
...
//      boChecksumInHuman,  {!}{ dorobit ci checksum sa dava do humanreadable}
      ...
      ,boAddLeadingZero
      ,boAutoSecurity
      ,boNoUpdateAfterSymbologyChange // no change property Barcode and anothen
                                      // when BarcodeSymbology change
//      ,boHideIfEmpty
//      ,boHideIfException
